...
__all__ = ['VGG16', 'ResNet', 'resnet50', 'resnet101', 'resnet152']
...
def ResNet152(in_channel=3, pretrained=True):
    """Constructs a ResNet-101 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(Bottleneck, [3, 8, 36, 3], in_channel=in_channel, pretrained=pretrained)
    return model
...
class FPN(nn.Module):
    ...
    def __init__(self, num_classes, in_channel, num_blocks=[2,4,23,3], back_bone='resnet', pretrained=False):
