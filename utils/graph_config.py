...
# ---------------------------------------------------------------------------- #
_C.MODEL.ATSS = CN()
_C.MODEL.ATSS.NUM_CLASSES = 12  # the number of classes including background
...
# ---------------------------------------------------------------------------- #
_C.MODEL.FCOS = CN()
_C.MODEL.FCOS.NUM_CLASSES = 10  # the number of classes including background
...
_C.MODEL.RETINANET.NUM_CLASSES = 12
...
_C.SOLVER.BACKBONE.BASE_LR = 0.01
...
_C.SOLVER.MIDDLE_HEAD.PLABEL_TH = (0.5,)
# ---------------------------------------------------------------------------- #
...
_C.MODEL.MIDDLE_HEAD.IN_NORM = 'GN'  # LN, GN, BN
...
_C.MODEL.MIDDLE_HEAD.GM.MATCHING_CFG = 'o2o'
_C.MODEL.MIDDLE_HEAD.GM.NODE_DIS_PLACE = 'feat' # 'intra', 'inter'
_C.MODEL.MIDDLE_HEAD.GM.WITH_QUADRATIC_MATCHING = False # point 二次分配损失
_C.MODEL.MIDDLE_HEAD.GM.WITH_CLUSTER_UPDATE = False # memory bank 更新
_C.MODEL.MIDDLE_HEAD.GM.WITH_SEMANTIC_COMPLETION = False # 语义补全 source补全target
_C.MODEL.MIDDLE_HEAD.GM.WITH_COMPLETE_GRAPH = True #  im 建图
_C.MODEL.MIDDLE_HEAD.GM.WITH_DOMAIN_INTERACTION = True
_C.MODEL.MIDDLE_HEAD.GM.WITH_COND_CLS = False
_C.MODEL.MIDDLE_HEAD.GM.WITH_CTR = False
_C.MODEL.MIDDLE_HEAD.GM.WITH_GLOBAL_GRAPH = False
...
# SIGMA++
_C.MODEL.MIDDLE_HEAD.GM.WITH_HyperGNN = True
